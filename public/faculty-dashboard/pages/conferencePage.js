    ...
    <section>
      ...
      <form id="conference-form" class="reveal">
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Venue/Location *</label><input name="location" class="form-control pub-input" placeholder="City, Country" /></div>
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Your Role</label><select name="role" class="form-select pub-input"><option>Select role</option><option>Participant</option><option>Presenter</option><option>Keynote Speaker</option></select></div>
          <div class="col-12 col-lg-6"><label class="form-label">Level</label><select name="level" class="form-select pub-input"><option>Select level</option><option>National</option><option>International</option><option>Regional</option></select></div>
