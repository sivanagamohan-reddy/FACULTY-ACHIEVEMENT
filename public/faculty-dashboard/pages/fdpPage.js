    ...
    <section>
      ...
      <form id="fdp-form" class="reveal">
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Start Date</label><input name="event_date" type="date" class="form-control pub-input" /></div>
