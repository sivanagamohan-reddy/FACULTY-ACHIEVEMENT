    ...
    <section>
      ...
      <form id="workshop-form" class="reveal">
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Your Role</label><select name="role" class="form-select pub-input"><option value="" selected>Select role</option><option>Participant</option><option>Resource Person</option><option>Coordinator</option></select></div>
