    ...
    <section>
      ...
      <form id="publication-form" class="reveal">
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Publication Date</label><input name="event_date" type="date" class="form-control pub-input" /></div>
          ...
          <div class="col-12 col-lg-6"><label class="form-label">Indexing</label><select name="indexing" class="form-select pub-input"><option>Select indexing</option><option>Scopus</option><option>WoS</option><option>UGC Care</option></select></div>
